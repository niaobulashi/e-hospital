  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['escort:member:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="所属商家" prop="memberBusinessName">
          <el-input v-model="form.memberBusinessName" placeholder="请输入所属商家" />
        </el-form-item>
        <el-form-item label="所属机构" prop="memberCorpName">
          <el-input v-model="form.memberCorpName" placeholder="请输入所属机构" />
        </el-form-item>
        <el-form-item label="姓名" prop="memberName">
          <el-input v-model="form.memberName" placeholder="请输入姓名" />
        </el-form-item>
        <el-form-item label="手机" prop="memberPhone">
          <el-input v-model="form.memberPhone" placeholder="请输入手机" />
        </el-form-item>
      </el-form>
...
<script>
import { listMember, getMember, delMember, addMember, updateMember } from "@/api/escort/member";
...
export default {
  ...
  methods: {
    ...
    reset() {
      this.form = {
        memberId: null,
        memberBusinessId: null,
        memberBusinessName: null,
        memberCorpId: null,
        memberCorpName: null,
        memberName: null,
        memberPhone: null,
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除会员信息编号为"' + memberIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('escort/member/export', {
        ...this.queryParams
