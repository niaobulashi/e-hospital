...
public class RandInfoUtils {
    //    private static String familyName1 = "赵钱孙李周吴郑王冯陈褚卫蒋沈韩杨朱秦尤许何吕施张孔曹严华金魏陶姜戚谢邹喻水云苏潘葛奚范彭郎鲁韦昌马苗凤花方俞任袁柳鲍史唐费岑薛雷贺倪汤滕殷罗毕郝邬安常乐于时傅卞齐康伍余元卜顾孟平"
//            + "黄和穆萧尹姚邵湛汪祁毛禹狄米贝明臧计成戴宋茅庞熊纪舒屈项祝董粱杜阮席季麻强贾路娄危江童颜郭梅盛林刁钟徐邱骆高夏蔡田胡凌霍万柯卢莫房缪干解应宗丁宣邓郁单杭洪包诸左石崔吉"
//            + "龚程邢滑裴陆荣翁荀羊甄家封芮储靳邴松井富乌焦巴弓牧隗山谷车侯伊宁仇祖武符刘景詹束龙叶幸司韶黎乔苍双闻莘劳逄姬冉宰桂牛寿通边燕冀尚农温庄晏瞿茹习鱼容向古戈终居衡步都耿满弘国文东殴沃曾关红游盖益桓公晋楚闫";
    private static String familyName1 = "赵钱孙李周吴郑王冯陈褚蒋沈韩杨朱秦许何吕张孔曹严魏陶姜谢邹苏潘葛范彭鲁马苗方任袁柳鲍史唐薛贺罗于齐顾孟"
            + "黄和穆萧尹姚邵汪祁毛臧计成戴宋庞纪项祝董粱杜阮席季贾路娄江颜郭林钟徐邱高夏蔡田胡霍卢邓洪包石崔"
            + "程邢裴陆靳焦谷侯武刘景詹叶司乔牛庄瞿习向古耿国文曾关楚闫";
    private static String familyName2 = "欧阳太史端木上官司马东方独孤南宫万俟闻人夏侯诸葛尉迟公羊赫连澹台皇甫宗政濮阳公冶太叔申屠公孙慕容仲孙钟离长孙宇文司徒鲜于司空闾丘子车亓官司寇巫马公西颛孙壤驷公良漆雕乐正宰父谷梁拓跋夹谷轩辕令狐段干百里呼延东郭南门羊舌微生公户公玉公仪梁丘公仲公上公门公山公坚左丘公伯西门公祖第五公乘贯丘公皙南荣东里东宫仲长子书子桑即墨达奚褚师吴铭";
     ...
     * @return
     */
    public static String getSingleFamilyName() {
        String str = "张";
     ...
     * @return
     */
    public static String[] getFamilyNameAndSex() {
        String[] nameAndSex = getNameAndSex(getSex());
        nameAndSex[0] = getSingleFamilyName().concat(nameAndSex[0]);
        return nameAndSex;
    }
    ...
    public static void main(String[] args) {
        for(int i=0;i<50;i++){
            String[] nameAndSex = getFamilyNameAndSex();
            System.out.println("姓名："+nameAndSex[0] +",性别："+nameAndSex[1]);
        }
    }
}
